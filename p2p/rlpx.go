...
import (
	...
	"github.com/Tau-Coin/taucoin-mobile-mining-go/crypto/ecies"
...
// and also verifies whtauer the encryption handshake 'worked' and the
...
type authMsgV4 struct {
	gotPlain bool // whtauer read packet had plain format.
