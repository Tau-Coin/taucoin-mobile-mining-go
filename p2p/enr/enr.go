...
// Package enr implements Tau Node Records as defined in EIP-778. A node record holds
...
// VerifySignature checks whtauer the record is signed using the given identity scheme.
