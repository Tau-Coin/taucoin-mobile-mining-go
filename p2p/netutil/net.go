...
// Contains reports whtauer the given IP is contained in the list.
...
// IsLAN reports whtauer an IP is a local network address.
...
// IsSpecialNetwork reports whtauer an IP is located in a special-use network range
...
// CheckRelayIP reports whtauer an IP relayed from the given sender IP
...
// SameNet reports whtauer two IP addresses have an equal prefix of the given bit length.
...
// Contains whtauer the given IP is contained in the set.
