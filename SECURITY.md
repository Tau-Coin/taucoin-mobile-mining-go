...
Audit reports are published in the `docs` folder: https://github.com/Tau-Coin/taucoin-mobile-mining-go/tree/master/docs/audits 


| Scope | Date | Report Link |
| ------- | ------- | ----------- |
| `gtau` | 20170425 | [pdf](https://github.com/Tau-Coin/taucoin-mobile-mining-go/blob/master/docs/audits/2017-04-25_Gtau-audit_Truesec.pdf) |
| `clef` | 20180914 | [pdf](https://github.com/Tau-Coin/taucoin-mobile-mining-go/blob/master/docs/audits/2018-09-14_Clef-audit_NCC.pdf) |
...
To find out how to disclose a vulnerability in Tau visit [https://bounty.tau.org](https://bounty.tau.org) or email bounty@tau.org.
