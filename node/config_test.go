...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gtau.ipc", false, filepath.Join(os.TempDir(), "gtau.ipc")},
		{"data", "gtau.ipc", false, "data/gtau.ipc"},
		{"data", "./gtau.ipc", false, "./gtau.ipc"},
		{"data", "/gtau.ipc", false, "/gtau.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gtau.ipc", true, `\\.\pipe\gtau.ipc`},
		{"data", "gtau.ipc", true, `\\.\pipe\gtau.ipc`},
		{"data", `\\.\pipe\gtau.ipc`, true, `\\.\pipe\gtau.ipc`},
	}
