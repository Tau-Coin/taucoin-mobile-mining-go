...
func TestCheckCompatible(t *testing.T) {
	...
	tests := []test{
		{stored: AllTauashProtocolChanges, new: AllTauashProtocolChanges, head: 0, wantErr: nil},
		{stored: AllTauashProtocolChanges, new: AllTauashProtocolChanges, head: 100, wantErr: nil},
		{
		...
		{
			stored: AllTauashProtocolChanges,
