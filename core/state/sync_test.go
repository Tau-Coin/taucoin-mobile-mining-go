...
// account array.
func checkStateAccounts(t *testing.T, db taudb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db taudb.Database, root common.Hash) error {
...
func checkStateConsistency(db taudb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(taudb.Database), srcRoot)
