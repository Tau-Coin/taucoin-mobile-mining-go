...
func (l *JSONLogger) CaptureState(env *EVM, pc uint64, gas, cost uint64, err error) error {
	log := StructLog{
		Pc:            pc,
		Gas:           gas,
		GasCost:       cost,
...
func (l *JSONLogger) CaptureFault(env *EVM, pc uint64, gas, cost uint64, err error) error {
	return nil
}
