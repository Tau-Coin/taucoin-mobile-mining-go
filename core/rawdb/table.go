...
func NewTable(db taudb.Database, prefix string) taudb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
// database.
func (t *table) AppendAncient(number uint64, hash, header, body, td []byte) error {
	return t.db.AppendAncient(number, hash, header, body, td)
}
...
func (t *table) NewIterator() taudb.Iterator {
...
func (t *table) NewBatch() taudb.Batch {
...
func (b *tableBatch) Replay(w taudb.KeyValueWriter) error {
