...
// Package types contains data types related to Tau consensus.
package types
...
// a block's data contents (transactions and uncles) togtauer.
type Body struct {
	Transactions []*Transaction
}

// Block represents an entire block in the Tau blockchain.
type Block struct {
	header       *Header
	...
	// These fields are used by package tau to track
...
// "external" block encoding. used for tau protocol, etc.
...
// EncodeRLP serializes b into the Tau RLP block format.
