...
// Package forkid implements EIP-2124 (https://eips.tau.org/EIPS/eip-2124).
package forkid
...
// NewID calculates the Tau fork ID from the chain config and head.
...
func newFilter(config *params.ChainConfig, genesis common.Hash, headfn func() uint64) func(id ID) error {
	...
	return func(id ID) error {
		...
		return nil // Somtauing's very wrong, accept rather than reject
	}
}
