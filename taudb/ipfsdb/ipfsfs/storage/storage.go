...
// Common error.
var (
	ErrInvalidFile = errors.New("ipfsdb/storage: invalid file for argument")
	ErrLocked      = errors.New("ipfsdb/storage: already locked")
	ErrClosed      = errors.New("ipfsdb/storage: closed")
)
