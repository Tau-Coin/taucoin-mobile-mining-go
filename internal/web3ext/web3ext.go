...
// package web3ext contains gtau specific web3.js extensions.
package web3ext
...
web3._extend({
	...
	methods: [
		new web3._extend.Method({
			name: 'getWork',
			call: 'tauhash_getWork',
			params: 0
		}),
		new web3._extend.Method({
			name: 'getHashrate',
			call: 'tauhash_getHashrate',
			params: 0
		}),
		new web3._extend.Method({
			name: 'submitWork',
			call: 'tauhash_submitWork',
			params: 3,
		}),
		new web3._extend.Method({
			name: 'submitHashRate',
			call: 'tauhash_submitHashRate',
			params: 2,
		}),
	]
});
...
web3._extend({
	...
	methods: [
		...
		new web3._extend.Method({
			...
			call: 'tau_submitTransaction',
			params: 1,
			inputFormatter: [web3._extend.formatters.inputTransactionFormatter]
		}),
		new web3._extend.Method({
			name: 'fillTransaction',
			call: 'tau_fillTransaction',
			params: 1,
			inputFormatter: [web3._extend.formatters.inputTransactionFormatter]
		}),
		new web3._extend.Method({
			name: 'getHeaderByNumber',
			call: 'tau_getHeaderByNumber',
			params: 1
		}),
		new web3._extend.Method({
			name: 'getHeaderByHash',
			call: 'tau_getHeaderByHash',
			params: 1
		}),
		new web3._extend.Method({
			name: 'getBlockByNumber',
			call: 'tau_getBlockByNumber',
			params: 2
		}),
		new web3._extend.Method({
			name: 'getBlockByHash',
			call: 'tau_getBlockByHash',
			params: 2
		}),
		new web3._extend.Method({
			name: 'getRawTransaction',
			call: 'tau_getRawTransactionByHash',
			params: 1
		}),
		new web3._extend.Method({
			name: 'getRawTransactionFromBlock',
			call: function(args) {
				return (web3._extend.utils.isString(args[0]) && args[0].indexOf('0x') === 0) ? 'tau_getRawTransactionByBlockHashAndIndex' : 'tau_getRawTransactionByBlockNumberAndIndex';
			},
			params: 2,
	...
	properties: [
		new web3._extend.Property({
			...
			getter: 'tau_pendingTransactions',
