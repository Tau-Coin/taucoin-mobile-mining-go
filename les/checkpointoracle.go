...
type checkpointOracle struct {
	...
	// Whtauer the contract backend is set.
	running int32
...
// isRunning returns an indicator whtauer the registrar is running.
...
// checks whtauer there are enough approvals to finalize the checkpoint.
