...
func newClientHandler(ulcServers []string, ulcFraction int, checkpoint *params.TrustedCheckpoint, backend *LightTau) *clientHandler {
...
func (d *downloaderPeerNotify) registerPeer(p *peer) {
	...
	h.downloader.RegisterLightPeer(p.id, tauVersion, pc)
}
