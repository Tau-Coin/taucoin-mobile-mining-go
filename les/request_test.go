...
type accessTestFn func(db taudb.Database, bhash common.Hash, number uint64) light.OdrRequest

func TestBlockAccessLes2(t *testing.T) { testAccess(t, 2, tfBlockAccess) }
func TestBlockAccessLes3(t *testing.T) { testAccess(t, 3, tfBlockAccess) }

func tfBlockAccess(db taudb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfReceiptsAccess(db taudb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfTrieEntryAccess(db taudb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfCodeAccess(db taudb.Database, bhash common.Hash, num uint64) light.OdrRequest {
