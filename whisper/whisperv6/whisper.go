...
// Whisper represents a dark communication interface through the Tau
...
// New creates a Whisper client ready to communicate through the Tau P2P network.
...
// param isP2P indicates whtauer the message is peer-to-peer (should not be forwarded).
