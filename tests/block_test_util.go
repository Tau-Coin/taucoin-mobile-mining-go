...
// Package tests implements execution of Tau JSON tests.
package tests
...
/* See https://github.com/tau/tests/wiki/Blockchain-Tests-II

   Whtauer a block is valid or not is a bit subtle, it's defined by presence of
