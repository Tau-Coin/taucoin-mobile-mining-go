...
* The external method `account_signTypedData` implements [EIP-712](https://github.com/tau/EIPs/blob/master/EIPS/eip-712.md) and makes it possible to sign typed data.
...
makes the `accounts_signTransaction` identical to the old `tau_signTransaction`.
