...
```json
{
  ...
  "call_info": [
    {
      "type": "Warning",
      "message": "Somtauing looks odd, show this message as a warning"
    },
    {
      "type": "Info",
...
Response to list request. The response contains a list of all addresses to show to the caller. Note: the UI is free to respond with any address the caller, regardless of whtauer it exists or not
