...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage Tau presale wallets",
		ArgsUsage: "",
		Category:  "ACCOUNT COMMANDS",
		Description: `
    gtau wallet import /path/to/my/presale.wallet

will prompt for your password and imports your tauer presale account.
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import Tau presale wallet",
				ArgsUsage: "<keyFile>",
				...
				Description: `
	gtau wallet [options] /path/to/my/presale.wallet
...
between tau nodes by simply copying.
...
For non-interactive use the password can be specified with the --password flag:
    ...
    gtau account update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    gtau account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another tau instance,
...
func accountCreate(ctx *cli.Context) error {
	cfg := gtauConfig{Node: defaultNodeConfig()}
	// Load config file.
