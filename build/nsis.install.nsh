Name "gtau ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/Tau-Coin/taucoin-mobile-mining-go/issues"
!define UPDATEURL "https://github.com/Tau-Coin/taucoin-mobile-mining-go/releases"
!define ABOUTURL "https://github.com/Tau-Coin/taucoin-mobile-mining-go#tau-go"
...
# Install gtau binary
Section "Gtau" GTAU_IDX
  SetOutPath $INSTDIR
  file {{.Gtau}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gtau.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gtau.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gtau incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gtau outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gtau UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gtau incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\gtau.exe" "" "" "Tau" 30303 "" "" ""
  SimpleFC::AdvAddRule "Gtau outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\gtau.exe" "" "" "Tau" "" 30303 "" ""
  SimpleFC::AdvAddRule "Gtau UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\gtau.exe" "" "" "Tau" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/tau/EIPs/issues/147)
  ${EnvVarUpdate} $0 "TAUEREUM_SOCKET" "R" "HKLM" "\\.\pipe\gtau.ipc"
  ${EnvVarUpdate} $0 "TAUEREUM_SOCKET" "A" "HKLM" "\\.\pipe\gtau.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${GTAU_IDX}
    SectionGetSize ${GTAU_IDX} $0
