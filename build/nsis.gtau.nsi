...
# 1. install gtau for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gtau
# 5. create gtau, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable TAUEREUM_SOCKET
...
!define GROUPNAME "Tau"
!define APPNAME "Gtau"
!define DESCRIPTION "Official Go implementation of the Tau protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gtau is installed global
