...
const (
	...
	subscribeTimeout   = 5 * time.Second  // overall timeout tau_subscribe, rpc_modules calls
)
...
type requestOp struct {
	...
	sub  *ClientSubscription  // only set for TauSubscribe requests
}
...
// TauSubscribe registers a subscripion under the "tau" namespace.
func (c *Client) TauSubscribe(ctx context.Context, channel interface{}, args ...interface{}) (*ClientSubscription, error) {
	return c.Subscribe(ctx, "tau", channel, args...)
}
