...
//
// tau_getBlockByNumber("latest", {})
//    returns the latest block object.
//
// tau_subscribe("newBlocks")
...
func subscribeBlocks(client *rpc.Client, subch chan Block) {
	...
	sub, err := client.TauSubscribe(ctx, subch, "newHeads")
	if err != nil {
	...
	var lastBlock Block
	if err := client.CallContext(ctx, &lastBlock, "tau_getBlockByNumber", "latest"); err != nil {
