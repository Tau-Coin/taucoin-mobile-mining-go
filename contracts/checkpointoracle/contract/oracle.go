...
// DeployCheckpointOracle deploys a new Tau contract, binding an instance of CheckpointOracle to it.
...
// CheckpointOracle is an auto generated Go binding around an Tau contract.
...
// CheckpointOracleCaller is an auto generated read-only Go binding around an Tau contract.
type CheckpointOracleCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// CheckpointOracleTransactor is an auto generated write-only Go binding around an Tau contract.
type CheckpointOracleTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// CheckpointOracleFilterer is an auto generated log filtering Go binding around an Tau contract events.
type CheckpointOracleFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// CheckpointOracleSession is an auto generated Go binding around an Tau contract,
...
// CheckpointOracleCallerSession is an auto generated read-only Go binding around an Tau contract,
...
// CheckpointOracleTransactorSession is an auto generated write-only Go binding around an Tau contract,
...
// CheckpointOracleRaw is an auto generated low-level Go binding around an Tau contract.
type CheckpointOracleRaw struct {
	Contract *CheckpointOracle // Generic contract binding to access the raw methods on
}

// CheckpointOracleCallerRaw is an auto generated low-level read-only Go binding around an Tau contract.
...
// CheckpointOracleTransactorRaw is an auto generated low-level write-only Go binding around an Tau contract.
