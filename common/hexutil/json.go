...
// Byte20 marshals/unmarshals as a JSON string with 0x prefix.
type Byte20 [20]byte

// MarshalText implements encoding.TextMarshaler
func (b Byte20) MarshalText() ([]byte, error) {
	result := make([]byte, len(b)*2+2)
	copy(result, `0x`)
	hex.Encode(result[2:], b[0:])
	return result, nil
...
// UnmarshalJSON implements json.Unmarshaler.
func (b *Byte20) UnmarshalJSON(input []byte) error {
	if !isString(input) {
		return errNonString(bytesT)
	}
	return wrapTypeError(b.UnmarshalText(input[1:len(input)-1]), bytesT)
...
// UnmarshalText implements encoding.TextUnmarshaler.
func (b *Byte20) UnmarshalText(input []byte) error {
	raw, err := checkText(input, true)
	if err != nil {
		return err
	}
...
// ImplementsGraphQLType returns true if Bytes implements the specified GraphQL type.
func (b Byte20) ImplementsGraphQLType(name string) bool { return name == "Byte20" }

// UnmarshalGraphQL unmarshals the provided GraphQL query data.
func (b *Byte20) UnmarshalGraphQL(input interface{}) error {
	var err error
	switch input := input.(type) {
	case string:
		data, err := Decode(input)
...
// Byte144 marshals/unmarshals as a JSON string with 0x prefix.
type Byte144 [144]byte

// MarshalText implements encoding.TextMarshaler
func (b Byte144) MarshalText() ([]byte, error) {
	result := make([]byte, len(b)*2+2)
	copy(result, `0x`)
	hex.Encode(result[2:], b[0:])
	return result, nil
...
// UnmarshalJSON implements json.Unmarshaler.
func (b *Byte144) UnmarshalJSON(input []byte) error {
	if !isString(input) {
		return errNonString(bytesT)
	}
	return wrapTypeError(b.UnmarshalText(input[1:len(input)-1]), bytesT)
...
// UnmarshalText implements encoding.TextUnmarshaler.
func (b *Byte144) UnmarshalText(input []byte) error {
	raw, err := checkText(input, true)
	if err != nil {
		return err
	}
...
// String returns the hex encoding of b.
func (b Byte144) String() string {
	return Encode(b[0:])
}

// ImplementsGraphQLType returns true if Bytes implements the specified GraphQL type.
func (b Byte144) ImplementsGraphQLType(name string) bool { return name == "Byte144" }

// UnmarshalGraphQL unmarshals the provided GraphQL query data.
func (b *Byte144) UnmarshalGraphQL(input interface{}) error {
	var err error
	switch input := input.(type) {
	case string:
		data, err := Decode(input)
