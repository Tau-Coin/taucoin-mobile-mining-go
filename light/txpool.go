...
// to the TAU network. The implementations of the functions should be non-blocking.
//
...
// validateTx checks whtauer a transaction is valid according to the consensus rules.
