...
type GlogHandler struct {
	...
	override  uint32 // Flag whtauer overrides are used, atomically accessible
	backtrace uint32 // Flag whtauer backtrace location is set
...
func (h *GlogHandler) Log(r *Record) error {
	// If backtracing is requested, check whtauer this is the callsite
