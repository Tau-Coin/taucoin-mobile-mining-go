...
// information related to the Tau protocol such als blocks, transactions and logs.
...
// `tau_getFilterChanges` polling method that is also used for log filters.
//
// https://github.com/tau/wiki/wiki/JSON-RPC#tau_newpendingtransactionfilter
...
// It is part of the filter package since polling goes with tau_getFilterChanges.
//
// https://github.com/tau/wiki/wiki/JSON-RPC#tau_newblockfilter
...
func (api *PublicFilterAPI) Logs(ctx context.Context, crit FilterCriteria) (*rpc.Subscription, error) {
	...
	logsSub, err := api.events.SubscribeLogs(tau.FilterQuery(crit), matchedLogs)
	if err != nil {
		return nil, err
	}
...
// Same as tau.FilterQuery but with UnmarshalJSON() method.
type FilterCriteria tau.FilterQuery
...
//
// https://github.com/tau/wiki/wiki/JSON-RPC#tau_newfilter
func (api *PublicFilterAPI) NewFilter(crit FilterCriteria) (rpc.ID, error) {
	logs := make(chan []*types.Log)
	logsSub, err := api.events.SubscribeLogs(tau.FilterQuery(crit), logs)
	if err != nil {
		return rpc.ID(""), err
	}
...
//
// https://github.com/tau/wiki/wiki/JSON-RPC#tau_getlogs
...
//
// https://github.com/tau/wiki/wiki/JSON-RPC#tau_uninstallfilter
...
//
// https://github.com/tau/wiki/wiki/JSON-RPC#tau_getfilterlogs
...
//
// https://github.com/tau/wiki/wiki/JSON-RPC#tau_getfilterchanges
