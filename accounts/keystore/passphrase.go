...
The crypto is documented at https://github.com/tau/wiki/wiki/Web3-Secret-Storage-Definition
	...
	if !ks.skipKeyFileVerification {
		...
		if err != nil {
			msg := "An error was encountered when saving and verifying the keystore file. \n" +
				...
				"https://github.com/Tau-Coin/taucoin-mobile-mining-go/issues." +
				"The error was : %s"
...
func DecryptKey(keyjson []byte, auth string) (*Key, error) {
	...
	return &Key{
		Id:         uuid.UUID(keyId),
		Address:    crypto.PubkeyToAddress(crypto.PublicKey(key.PublicKey)),
		PrivateKey: key,
	}, nil
}
