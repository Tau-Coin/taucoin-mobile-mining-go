...
// See https://github.com/tau/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
type KeyStore struct {
	...
	updating    bool                    // Whtauer the event notification loop is running
...
// HasAddress reports whtauer a key with the given address is present.
...
// ImportPreSaleKey decrypts the given Tau presale wallet and stores
