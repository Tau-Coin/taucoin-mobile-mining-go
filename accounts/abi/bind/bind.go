...
// Package bind generates Tau contract Go bindings.
//
// Detailed usage document and tutorial available on the go-tau Wiki page:
// https://github.com/Tau-Coin/taucoin-mobile-mining-go/wiki/Native-DApps:-Go-bindings-to-Tau-contracts
package bind
...
// structured checks whtauer a list of ABI data types has enough information to
