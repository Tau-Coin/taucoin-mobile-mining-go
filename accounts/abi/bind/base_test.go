...
func (mc *mockCaller) CallContract(ctx context.Context, call tau.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func TestPassingBlockNumber(t *testing.T) {
	...
	bc.Call(&bind.CallOpts{BlockNumber: blockNumber}, &ret, "somtauing")
	...
	bc.Call(&bind.CallOpts{}, &ret, "somtauing")
