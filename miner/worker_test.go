...
var (
	...
	tauhashChainConfig *params.ChainConfig
...
func init() {
	...
	tauhashChainConfig = params.TestChainConfig
...
func newTestWorker(t *testing.T, chainConfig *params.ChainConfig, engine consensus.Engine, blocks int) (*worker, *testWorkerBackend) {
	...
	w.setTauerbase(testBankAddress)
	return w, backend
}

func TestPendingStateAndBlockTauash(t *testing.T) {
	testPendingStateAndBlock(t, tauhashChainConfig, tauhash.NewFaker())
}
...
func TestEmptyWorkTauash(t *testing.T) {
	testEmptyWork(t, tauhashChainConfig, tauhash.NewFaker())
}
...
func TestStreamUncleBlock(t *testing.T) {
	tauhash := tauhash.NewFaker()
	defer tauhash.Close()

	w, b := newTestWorker(t, tauhashChainConfig, tauhash, 1)
	defer w.close()
...
func TestRegenerateMiningBlockTauash(t *testing.T) {
	testRegenerateMiningBlock(t, tauhashChainConfig, tauhash.NewFaker())
}
...
func TestAdjustIntervalTauash(t *testing.T) {
	testAdjustInterval(t, tauhashChainConfig, tauhash.NewFaker())
}
